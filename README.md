...
- [Open Archiver](https://openarchiver.com/) - Open Archiver is a secure, self-hosted email archiving solution, and it's completely open source. ([Source Code](https://github.com/LogicLabs-OU/OpenArchiver)) `AGPL-3.0` 
